...
**Stated limits — what this cap is, and what it is not.** **This cap is stated, not mechanically enforced.** Three limits, written down so nobody reads a pin where there is prose:
