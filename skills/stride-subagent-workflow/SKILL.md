...
- **The authorized, non-production confirmation** — state it in the block. This is the determination already required before you dispatch (see the sanctioned-surfaces paragraph above); the bullet records it, it does not re-open it, and you never supply it on the user's behalf
